...
["Cancel issue #{id}"] = "Ακύρωση θέματος #{id}";
["Cancel issue now"] = "Ακύρωση θέματος τώρα";
["Cancel refuse of invitation"] = "Ακύρωση απόρριψης της πρόσκλησης";
["Cancel registration"] = "Ακύρωση εγγραφής";
["Canceled"] = "Ακυρωμένο";
["Canceled (before accepted due to revocation)"] =  "Ακυρωμένο (πριν την έγκριση, λόγω ανάκλησης)";
["Canceled (during discussion due to revocation)"] = "Ακυρωμένο (κατά την συζήτηση, λόγω ανάκλησης)";
["Canceled (during verification due to revocation)"] = "Ακυρωμένο (κατά την επιβεβαίωση, λόγω ανάκλησης)";
["Canceled (issue not accepted)"] = "Ακυρωμένο (το θέμα δεν έγινε αποδεκτό)";
["Canceled (no initiative admitted)"] = "Ακυρωμένο (καμμία εισαγωγή πρωτοβουλίας)";
...
["Change notification settings"] = "Αλλαγή ρυθμίσεων για τις ειδοποιήσεις";
...
["Check delegations"] = "Έλεγχος αναθέσεων";
...
["Closed user group, please login to participate."] = "Παρακαλώ συνδέσου για να συμμετέχεις.";
...
["Discuss with initiators"] = "Συζήτησε με τους εισηγητές";
["Discussion"] = "Συζήτηση";
...
["Free timing"] = "Άνευ χρονικού ορίου";
["Friday"] = "Παρασκευή";
["Frozen"] = "Παγωμένο";
...
["Please choose two versions of the draft to compare"] = "Παρακαλώ επέλεξε δύο εκδόσεις του προσχεδίου για να τις συγκρίνεις.";
...
["Please enter the invite code you've received."] = "Παρακαλώ κάνε εισαγωγή του κωδικού πρόσκλησης που έχεις λάβει.";
...
["This issue has been canceled by administrative intervention."] = "Αυτό το θέμα ακυρώθηκε με παρέμβαση διαχειριστή.";
["This issue has been canceled."] = "Αυτό το θέμα ακυρώθηκε.";
["This issue has been canceled. It failed the quorum of #{quorum}."] = "Αυτό το θέμα ακυρώθηκε. Δεν συγκέντρωσε την απαραίτητη απαρτία #{quorum}.";
...
["You are already not supporting this initiative"] = "Ήδη δεν υποστηρίζεις αυτή την πρωτοβουλία";
...
["You are interested"] = "Σε ενδιαφέρει";
...
["You are invited to become initiator of this initiative."] = "Είσαι προσκεκλημένος να γίνεις εισηγητής αυτής της πρωτοβουλίας.";
...
["You are participating in this area"] = "Συμμετέχεις";
["You are potential supporter"] = "Είσαι δυνητικός υποστηρικτής";
["You are potential supporter of this initiative"] = "Είσαι δυνητικός υποστηρικτής αυτής της πρωτοβουλίας";
["You are potential supporter of this initiative via delegation"] = "Είσαι δυνητικός υποστηρικτής αυτής της πρωτοβουλίας μέσω ανάθεσης";
["You are supporter"] = "Είσαι υποστηρικτής";
["You are supporter of this initiative"] = "Είσαι υποστηρικτής αυτής της πρωτοβουλίας";
...
["You have ignored this member"] = "Έχεις αγνοήσει αυτό το μέλος";
...
["You have voting privileges for this unit"] = "Έχεις δικαίωμα ψήφου σε αυτήν την ενότητα";
["You need to be logged in, to use all features of this system."] = "Πρέπει να είσαι συνδεδεμένος, για να έχεις πρόσβαση σε όλες τις δυνατότητες αυτού του συστήματος.";
["You were interested"] = "Σε ενδιέφερε";
...
["Your support has been added to this initiative"] = "Η υποστήριξή σου έχει προστεθεί στην πρωτοβουλία";
["Your support has been removed from this initiative"] = "Η υποστήριξή σου έχει αποσυρθεί από την πρωτοβουλία";
